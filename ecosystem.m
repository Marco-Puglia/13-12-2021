...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %Tfunc  0.06 0.1
    TfuncA = 1 .* exp(p.tempfuA*(p.T-20)); %%%%%%%%%%%%%%%%%%CHANGE THIS FOR EXPERIMENTS%%%%%%%%%%%%%%%%%%
    TfuncH = 1 .* exp(p.tempfuZ*(p.T-20)); %%%%%%%%%%%%%%%%%%CHANGE THIS FOR EXPERIMENTS%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Nuptk    = TfuncA .* limitation .* mumax .* alphaN ./ (mumax + alphaN);
    Nuptk(mumax + alphaN<=0) = 0; % Check for possible divide by zero
    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % GRAZING
    g = TfuncH .* p.g; % [jpred x ns] % GRAZING ATTACK RATE % Implicit Expansion of row and column - expands input vectors for matrix of all possible combinations
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % ODEs
    dNdt = - sum(Nuptk.*P,1) ...           %-N inside the organisms
           + p.kappa .* (p.Nsupply - N);   %+N in organisms transformed into N free (death? escretion?)
